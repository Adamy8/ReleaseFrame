...
# Train with no interrupting: (-u for unbuffered output, not sure it will work)
    # nohup python -u train_cnn_tcn.py --dataset dataset --epochs 25 --batch-size 4 --device cuda > train.log 2>&1 &
